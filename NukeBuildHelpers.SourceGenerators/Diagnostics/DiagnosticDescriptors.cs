...
internal static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor InvalidAttributeCombinationForNukeBuildHelpersAttributeError = new DiagnosticDescriptor(
        id: "NBH0002",
        title: "Invalid target type for [NukeBuildHelpers]",
        messageFormat: "Cannot apply [NukeBuildHelpers] to type {0}, as it already has this attribute or [NukeBuildHelpers] applied to it (including base types)",
        category: typeof(NukeBuildCommonHelpersGenerator).FullName,
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "Cannot apply [NukeBuildHelpers] to a type that already has this attribute or [NukeBuildHelpers] applied to it (including base types).",
        helpLinkUri: "https://github.com/Kiryuumaru/NukeBuildHelpers");
}
