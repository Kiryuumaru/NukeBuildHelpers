...
partial class BaseNukeBuildHelpers
{
    ...
    public Target GithubWorkflow => _ => _
        ...
        .Executes(() =>
        {
            ...
            nukePreSetup.Add("run", $"{GetBuildScriptGithub(RunsOnType.Ubuntu2204)} PipelinePreSetup ; echo \"PRE_SETUP_OUTPUT=$(cat {RootDirectory / ".nuke" / "temp" / "pre_setup_output.json"})\" >> $GITHUB_OUTPUT");
