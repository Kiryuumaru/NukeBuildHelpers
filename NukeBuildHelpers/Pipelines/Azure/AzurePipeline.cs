...
internal class AzurePipeline(BaseNukeBuildHelpers nukeBuild) : IPipeline
{
    ...
    public async Task BuildWorkflow(BaseNukeBuildHelpers baseNukeBuildHelpers, AllEntry allEntry)
    {
        ...
        AddJobOrStepEnvVars(preSetupJob, envMap);
        ...
        foreach (var entryDefinition in preTestEntryDefinitionMap.Values)
        {
            ...
            AddJobOrStepEnvVars(testJob, envMap);
        ...
        foreach (var entryDefinition in allEntry.BuildEntryDefinitionMap.Values)
        {
            ...
            AddJobOrStepEnvVars(buildJob, envMap);
        ...
        foreach (var entryDefinition in allEntry.PublishEntryDefinitionMap.Values)
        {
            ...
            AddJobOrStepEnvVars(publishJob, envMap);
        ...
        var postSetupJob = AddJob(workflow, "POST_SETUP", $"Post Setup", pipelinePostSetupOs, timeoutMinutes: 30, needs: [.. postNeeds], condition: "always()");
        ...
        AddJobOrStepEnvVars(postSetupJob, envMap);
    ...
    private static void AddJobOrStepEnvVars(Dictionary<string, object> job, Dictionary<string, object> envMap)
    {
